...
export default async function DashboardPage() {
  ...
  const STATS = [
    { label: 'Courses',        val: courses.length,       icon: '📚', href: '/professor/courses' },
    { label: 'Chapters',       val: totalChapters,        icon: '📖', href: '/professor/courses' },
    { label: 'Resources',      val: totalResources,       icon: '📎', href: '/professor/courses' },
    { label: 'Announcements',  val: announcements.length, icon: '📣', href: '/professor/announcements/new' },
  ]
